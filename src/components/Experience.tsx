...
const marketingExp = [
  ...
  {
    title: "Product & Creator Operations",
    organization: "Holla Group",
    period: "2022 – 2023",
    description:
        ...
        >
          ...
          <div className="inline-flex rounded-lg bg-stone-100 p-0.5 gap-0.5">
            {(
              [
                {
                  key: "engineering" as Track,
                  label: "Software Engineering",
                  icon: Briefcase,
                },
                {
                  key: "marketing" as Track,
